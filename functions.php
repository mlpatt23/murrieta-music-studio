<?php
	...
	function murrietamusicstudio_styles() {
		...
		wp_register_style('ginger-grid', get_template_directory_uri() . '/css/ginger.min.css', array(), '2.1.1');
		
		wp_register_style('style', get_template_directory_uri() . '/style.css', array('normalize', 'ginger-grid'), '1.0');
  ...
  crossorigin="anonymous', array(), '3.2.1');
		...
		wp_register_script('ginger-grid', get_template_directory_uri() . '/js/ginger.min.js', array(), '2.1.1');
		
		wp_register_script('script', get_template_directory_uri() . '/js/script.js', array('jquery', 'ginger-grid'), '1.0', true);
		...
		wp_enqueue_style('ginger-grid');
		wp_enqueue_style('style');
		
		wp_enqueue_script('jquery');
		wp_enqueue_script('jqueryrotate');
		wp_enqueue_script('ginger-grid');
